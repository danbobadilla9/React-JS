...
//La opcion mas aceptada para recorrer un arreglo es utilizando .map 
        ...
        <div className="md:w-1/2 lg:w-3/5 md:h-screen overflow-y-scroll">
            { pacientes && pacientes.length ? (
                <>
                    ...
                    {pacientes.map( paciente => <Paciente key={ paciente.id } eliminarPaciente = { eliminarPaciente } paciente = { paciente } setPaciente = {setPaciente}/> )}
                </>
            ) : (
                <>

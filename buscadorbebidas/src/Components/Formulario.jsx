            ...
            <Row>
                ...
                <Col md={6}>
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control id='nombre' type="text" placeholder="Ej: Tequila, Vodka, etx" name="nombre" value={busqueda.nombre} onChange = {e => setBusqueda({...busqueda,[e.target.name]:e.target.value})}/>
                    </Form.Group>
                </Col>
